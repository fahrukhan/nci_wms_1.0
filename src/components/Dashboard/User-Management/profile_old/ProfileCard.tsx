...
type FormType = "username" | "password";
...
const Profile = () => {
  ...
  const openForm = (formType: FormType) =>
    setFormState({ isVisible: true, formType });
  const closeForm = () => setFormState({ isVisible: false, formType: "" });
  ...
  const renderForm = () => {
    if (formState.formType === "username") {
      return (
        <div
        ...
        >
          ...
          >
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-2xl font-bold">Change Username - Form</h2>
              <button
    ...
    } else if (formState.formType === "password") {
      return (
        <div
          className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50"
          onClick={handleBackgroundClick}
        >
          ...
          >
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-2xl font-bold">Change Password - Form</h2>
              <button
                className="rounded-md bg-gray-200 px-4 py-2 hover:bg-gray-300"
                onClick={closeForm}
              >
  ...
  return (
    <div className="bg-[#F7FBFF] flex-1 p-4">
      <div className="border-2 border-[#6D8CFF] rounded-2xl p-4 mt-4 max-w-md mx-auto">
        <div className="flex flex-col items-center">
          ...
          />
          <button className="mt-2 px-4 py-2 text-sm text-white bg-blue-500 rounded-full">
            Change Picture
          </button>
        </div>
        <div className="mt-4">
          ...
          <ul className="mt-2">
            <li className="flex justify-between border-b py-2">
              ...
              <span className="text-gray-800">useradmin@gmail.com</span>
            </li>
            <li className="flex justify-between border-b py-2">
              <span className="font-medium text-gray-600">Username:</span>
              <span className="text-gray-800">UserAdmin</span>
            </li>
            <li className="flex justify-between border-b py-2">
            ...
            <li className="flex justify-between py-2">
              ...
              <span className="text-gray-800">dd/mm/yy</span>
            </li>
          </ul>
        </div>
        <div className="flex justify-end gap-3 mt-4">
          <button
            className="px-4 py-2 text-sm text-white bg-red-500 rounded-full"
            onClick={() => openForm("username")}
          >
            Change Username
          </button>
          <button
      ...
      {formState.isVisible && renderForm()}
    </div>
  );
};
